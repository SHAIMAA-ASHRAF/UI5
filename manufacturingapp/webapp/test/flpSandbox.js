		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#manufacturingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"manufacturingapp-display": {
								"semanticObject": "manufacturingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=manufacturingapp",
									"url": sap.ui.require.toUrl("manufacturingapp")
								}
							}
						}
					}
